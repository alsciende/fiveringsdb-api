...
namespace Alsciende\SerializerBundle\Normalizer;
...
class Normalizer
{
    ...
    function __construct (\Alsciende\SerializerBundle\Manager\ObjectManagerInterface $objectManager, \Symfony\Component\Serializer\Serializer $serializer)
    {
